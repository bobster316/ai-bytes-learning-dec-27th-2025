  ...
  const handleSendMessage = async (text: string) => {
    ...
    setTimeout(() => {
      ...
      const aiMessage: Message = {
        role: 'assistant',
        content: 'This is where your AI response will appear. Connect to your Gemini API endpoint at /api/voice/message',
        timestamp: new Date()
      };
                  ...
                  messages.map((message, index) => (
                    ...
                    >
                      <motion.div
                        ...
                        className={`max-w-[80%] p-5 rounded-3xl backdrop-blur-xl ${
                          message.role === 'user'
