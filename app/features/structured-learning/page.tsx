...
export default function StructuredLearningPage() {
    const content = [
        ...
        "Our lessons are byte-sized by design, typically being concise enough to complete in a single sitting. This is not just a convenience; it is a cognitive necessity. Research into cognitive load theory suggests that our brains have a limited capacity for processing new information at once. When that capacity is exceeded, learning stops, and confusion begins. By limiting our lessons to focused, digestible chunks, we ensure that you remain in the optimal zone for retention and understanding throughout your journey.",

        "This micro-learning format also respects the reality of your busy professional life. Finding an hour to watch a lecture is difficult; finding time for a micro-lesson while commuting, waiting for a meeting, or having a morning coffee is entirely achievable. This consistency is the key to mastery. Studying with micro-lessons every day is infinitely more effective than studying for four hours once a month. Our structure facilitates this habit-forming behaviour, turning learning into a sustainable daily practice rather than a sporadic burden.",
