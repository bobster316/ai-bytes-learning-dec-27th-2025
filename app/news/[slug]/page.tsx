    ...
    <>
      ...
      <div className="min-h-screen bg-[#080810] selection:bg-[#4b98ad]/30 pt-32 pb-32">
        ...
        <header className="mb-12">
          <div className="flex items-center gap-3 text-[#4b98ad] font-mono text-xs uppercase tracking-widest mb-6 border-b border-white/5 pb-6">
            <span className="px-3 py-1 bg-[#4b98ad]/10 rounded-full border border-[#4b98ad]/20">AI Update</span>
        ...
        <article className="prose prose-invert prose-lg md:prose-xl max-w-none 
          ...
          prose-a:text-[#4b98ad] prose-a:no-underline hover:prose-a:underline
          ...
          <div className="mt-20 pt-10 border-t border-white/10">
            ...
            <ul className="space-y-3">
              {article.sources.map((source: string, idx: number) => (
                <li key={idx}>
                  <a href={source} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-white/40 hover:text-[#4b98ad] transition-colors break-all text-sm">
