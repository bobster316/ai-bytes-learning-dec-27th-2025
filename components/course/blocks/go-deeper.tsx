...
export function GoDeeper(props: ExpandableBlock) {
    ...
    return (
        <motion.div
            ...
            className="mb-10"
        >
            <div className="bg-[#0f0f1c] border border-[#00FFB3]/20 rounded-2xl overflow-hidden shadow-md">
                <button
                ...
                >
                    <div className="flex items-center gap-4">
                        <div className={`w-8 h-8 rounded-full border border-[#00FFB3]/30 flex items-center justify-center transition-transform duration-300 ${isOpen ? 'bg-[#00FFB3]/20 rotate-45' : 'bg-transparent'}`}>
                            <PlusCircle className={`w-5 h-5 ${isOpen ? 'text-[#00FFB3]' : 'text-[#8A8AB0]'}`} />
                        </div>
                ...
                <AnimatePresence initial={false}>
                    {isOpen && (
                        ...
                        >
                            <div className="p-6 md:p-8 pt-4 border-t border-[#00FFB3]/10 bg-[#161B33]/50">
