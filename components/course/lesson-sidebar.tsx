            ...
            <div className="space-y-6 overflow-y-auto scrollbar-hide flex-1">
                {outline.topics.map((topic, tIdx) => (
                    <div key={tIdx} className="space-y-2">
                        <div className="pl-3 border-l-2 border-[#4b98ad]/50 py-1 mb-3">
                            <div className="text-[9px] font-mono font-bold text-[#4b98ad] mb-0.5 uppercase tracking-widest">MODULE {tIdx + 1}</div>
                                ...
                                return (
                                    <Link
                                        ...
                                        className={cn(
                                            ...
                                            isActive
                                                ? "bg-[#4b98ad]/15 text-[#4b98ad] font-semibold border-l-2 border-[#4b98ad]"
                                                : "text-white/40 hover:bg-white/5 hover:text-white/70 border-l-2 border-transparent"
                                        )}
                                    >
                                        <div className="mt-0.5 shrink-0">
                                            {isActive ? (
                                                <Circle className="w-3 h-3 fill-[#4b98ad] text-[#4b98ad]" />
                                            ) : (
                                        ...
                                        <Link
                                            ...
                                            className={cn(
                                                ...
                                                isCompleted
                                                    ...
                                                    : "text-white/40 hover:bg-[#4b98ad]/8 hover:text-[#4b98ad] border border-dashed border-white/10 hover:border-[#4b98ad]/30"
                                            )}
                                        >
                                            <CheckCircle2 className={cn("w-3 h-3 shrink-0", isCompleted ? "text-[#00FFB3]" : "text-white/30 group-hover:text-[#4b98ad]")} />
