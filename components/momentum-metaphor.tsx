...
export function MomentumMetaphor() {
    return (
        <Card className="overflow-hidden bg-white dark:bg-slate-800/50 border-slate-200 dark:border-slate-700/50 shadow-sm relative">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#00FFB3]/5 blur-[60px] -mr-16 -mt-16"></div>

            <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-xl bg-[#00FFB3]/10 flex items-center justify-center">
                        <Info className="w-5 h-5 text-[#00FFB3]" />
                    </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-4">
                        <div className="w-8 h-8 rounded-lg bg-[#00FFB3]/20 flex items-center justify-center shrink-0">
                            <span className="text-[#00FFB3] font-bold text-xs">02</span>
                        </div>
                        <div>
