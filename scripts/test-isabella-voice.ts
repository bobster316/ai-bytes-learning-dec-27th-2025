...
async function testIsabellaVoice() {
    console.log('='.repeat(60));
    console.log('🧪 SARAH + ISABELLA VOICE TEST');
    console.log('='.repeat(60));

    try {
        const text = "Hi, I'm Sarah, and I'm now speaking with the Isabella voice from ElevenLabs. This is a final test to confirm that I sound exactly how you want me to. I am warm, clear, and ready to help you learn!";

        console.log('\n🎤 Generating audio with Isabella voice...');
        ...
        const uploadResult = await audioStorageService.uploadAudio(
            ...
            `isabella-voice-test-${Date.now()}.mp3`
        );
        ...
        const videoResult = await heyGenService.generateVideo({
            ...
            title: 'Sarah-Isabella Voice Test'
        });
